...
- [**Entity Resolution POC**](https://github.com/jayshah5696/entity-resolution): Autonomous entity resolution and triplet extraction system.
- [**pravah**](https://github.com/jayshah5696/pravah): LLM-powered local search engine architecture.
...
- [**session-aggregator**](https://github.com/jayshah5696/session-aggregator): Tooling for unified search and export across AI coding session histories.
...
- [Concept to Code - Deploying ColBERT with RAGatouille on Modal Labs in Minutes](https://jayshah.dev/posts/ragatouille/)
